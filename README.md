...
1. **It supports very large files.** MinIO, which we use for raw data storage, supports file sizes up to 5TB, and we have successfully uploaded files as large as 25GiB through our web interface. Since our lab deals primarily in volumetric microscope videos, which can grow quite large, this ability was important to us.
